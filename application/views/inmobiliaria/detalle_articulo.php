  ...
  <div class="carousel-main">
    ...
    <div class="col col-sm-3">
      <div class="panel panel-default">
        ...
        <div class="panel-body" style="padding-top: 5px; padding-bottom: 5px"><h4><?php if(isset($anuncio)) echo " RD$" . $anuncio->precio ;?></h4></div>
      </div>
      ...
      <a class="list-group-item active">Detalles del Vendedor</a>
       ...
       <a class="list-group-item"><span class="glyphicon glyphicon-phone-alt"></span><?php if(isset($anuncio->telefono)) echo " " . $anuncio->telefono ?></a>
       <a class="list-group-item"><span class="glyphicon glyphicon-phone"></span><?php if(isset($anuncio->celular)) echo " " . $anuncio->celular ?></a>
